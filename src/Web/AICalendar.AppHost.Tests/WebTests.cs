...
namespace AICalendar.AppHost.Tests;
...
public class WebTests
{
	...
	{
		// Arrange
		var appHost = await DistributedApplicationTestingBuilder.CreateAsync<AICalendar_AppHost>(TestContext.Current.CancellationToken);
